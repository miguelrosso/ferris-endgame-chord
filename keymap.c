...
#define DEFINE_ALL_CHORDS \
    ...
    DEFINE_CHORD(CHORD_CLIENT, "client", KC_K_HRM, KC_L_HRM, KC_S_HRM) CSEP\
    DEFINE_CHORD(CHORD_SERVER, "server", KC_S_HRM, KC_E, KC_R) CSEP\
    DEFINE_CHORD(CHORD_HORIZON, "horizon", KC_H_HRM, KC_Z_HRM, KC_N) CSEP\
    DEFINE_CHORD(CHORD_HZN, "hzn", KC_Z_HRM, KC_N) CSEP\
    ...
    DEFINE_CHORD(CHORD_INSTEAD, "instead", KC_N, KC_S_HRM, KC_T) CSEP\
    ...
    DEFINE_CHORD(CHORD_UNDER, "under", KC_U, KC_D_HRM, KC_R) CSEP\
    ...
    DEFINE_CHORD(CHORD_HAVE, "have", KC_H_HRM, KC_V) CSEP\
    ...
    DEFINE_CHORD(CHORD_SHE, "she", KC_S_HRM, KC_H_HRM, KC_E) CSEP\
    ...
    DEFINE_CHORD(CHORD_WELCOME, "welcome", KC_W, KC_M) CSEP\
    ...
    DEFINE_CHORD(CHORD_SEE, "see", KC_S_HRM, KC_E) CSEP\
    DEFINE_CHORD(CHORD_COME, "come", KC_C, KC_O, KC_M) CSEP\
    DEFINE_CHORD(CHORD_WANT, "want", KC_W, KC_N, KC_T) CSEP\
    DEFINE_CHORD(CHORD_LOOK, "look", KC_L_HRM, KC_K_HRM) CSEP\
    DEFINE_CHORD(CHORD_USE, "use", KC_U, KC_S_HRM, KC_E) CSEP\
    DEFINE_CHORD(CHORD_FIND, "find", KC_F_HRM, KC_N, KC_D_HRM) CSEP\
    DEFINE_CHORD(CHORD_TELL, "tell", KC_T, KC_E, KC_L_HRM) CSEP\
    DEFINE_CHORD(CHORD_LET, "let", KC_T, KC_L_HRM) CSEP\
    DEFINE_CHORD(CHORD_WORK, "work", KC_W, KC_R, KC_K_HRM) CSEP\
    DEFINE_CHORD(CHORD_TRY, "try", KC_T, KC_R, KC_Y) CSEP\
    DEFINE_CHORD(CHORD_NEED, "need", KC_N, KC_E, KC_D_HRM) CSEP\
    DEFINE_CHORD(CHORD_FEEL, "feel", KC_F_HRM, KC_E, KC_L_HRM) CSEP\
    DEFINE_CHORD(CHORD_PUT, "put", KC_P_HRM, KC_T) CSEP\
    DEFINE_CHORD(CHORD_MEAN, "mean", KC_N, KC_E, KC_M) CSEP\
    ...
    DEFINE_CHORD(CHORD_ONLY, "only", KC_N, KC_L_HRM) CSEP\
    ...
    DEFINE_CHORD(CHORD_NE, SS_TAP(X_BSPC) "n", KC_N, KC_SCLN) CSEP\
    DEFINE_CHORD(CHORD_RE, SS_TAP(X_BSPC) "'re", KC_R, KC_E, KC_SCLN) CSEP\
    DEFINE_CHORD(CHORD_ER, SS_TAP(X_BSPC) "er", KC_R, KC_SCLN) CSEP\
    DEFINE_CHORD(CHORD_EST, SS_TAP(X_BSPC) "est", KC_E, KC_S_HRM, KC_SCLN) CSEP\
    DEFINE_CHORD(CHORD_LY, SS_TAP(X_BSPC) "ly", KC_Y, KC_SCLN) CSEP\
    ...
    DEFINE_CHORD(CHORD_DEREF, SS_TAP(X_BSPC) "->", KC_D_HRM, KC_F_HRM, KC_SCLN) CSEP\
    DEFINE_CHORD(CHORD_QSN, SS_TAP(X_BSPC) "?", KC_Q, KC_SCLN) CSEP\
    DEFINE_CHORD(CHORD_QUOTES, SS_TAP(X_BSPC) "\"\"" SS_TAP(X_LEFT), KC_F, KC_SCLN) CSEP\
    DEFINE_CHORD(CHORD_PARENS, SS_TAP(X_BSPC) "()" SS_TAP(X_LEFT), KC_Z_HRM, KC_V, KC_SCLN) CSEP\
...
#define DEFINE_ALL_COMPOUNDS \
    ...
    DEFINE_COMPOUND(CHORD_ED, CHORD_KNOW, "knew") CSEP\
    DEFINE_COMPOUND(CHORD_NE, CHORD_DO, "done") CSEP\
    ...
    DEFINE_COMPOUND(CHORD_ING, CHORD_BECOME, "becoming") CSEP\
    DEFINE_COMPOUND(CHORD_ING, CHORD_LIKE, "liking") CSEP\
    DEFINE_COMPOUND(CHORD_S, CHORD_THIS, "these")
